      ...
      <div className="max-w-lg mx-auto px-4 sm:px-6 py-6">
        ...
        {saved ? (
          <div className="flex flex-col items-center py-16 text-center">
            ...
            <h2 className="text-lg font-bold text-gray-900">Expense saved!</h2>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <input
                  ...
                  placeholder="0.00"
                  required
                  className="flex-1 text-4xl font-bold text-red-500 bg-transparent border-none outline-none placeholder:text-gray-200 w-full"
                  autoFocus
                />
              </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  maxLength={200}
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent focus:bg-white placeholder:text-gray-300 transition"
                />
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent focus:bg-white transition"
                />
              </div>
              ...
              <div className="flex items-center justify-between py-1">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-700">Recurring expense</p>
                ...
                <button
                  ...
                  className={`relative w-11 h-6 rounded-full transition-colors ${recurring ? 'bg-red-500' : 'bg-gray-200'}`}
                >
