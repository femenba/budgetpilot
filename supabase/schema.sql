...
-- Admin account setup (run once after deploying):
-- update public.profiles set plan = 'pro', role = 'admin' where email = 'admin@budgetpilotapp.com';
-- update public.profiles set role = 'user' where email = 'femenbaa@gmail.com';
